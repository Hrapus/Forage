...
class ForageableDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getForageable(id = id).observe(this.viewLifecycleOwner){ selected ->
            forageable = selected
    ...
    private fun bindForageable(forageable: Forageable) {
        binding.apply {
            name.text = this@ForageableDetailFragment.forageable.name
            location.text = this@ForageableDetailFragment.forageable.address
            notes.text = this@ForageableDetailFragment.forageable.notes
            if (this@ForageableDetailFragment.forageable.inSeason) {
            ...
            editForageableFab.setOnClickListener {
                val action = ForageableDetailFragmentDirections
                    .actionForageableDetailFragmentToAddForageableFragment(this@ForageableDetailFragment.forageable.id)
